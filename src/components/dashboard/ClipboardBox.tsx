...
export default function ClipboardBox({ label, value }: Props) {
    ...
    return (
        <div className="mb-4">
            <div className="py-1 font-medium text-gray-800">{label}</div>
            <div className="relative rounded-2xl bg-white shadow-sm p-3 border border-gray-100 flex items-center justify-between">
                ...
                >
                    <span
                        className={`font-semibold text-gray-800 select-none transition-all duration-300 block whitespace-nowrap overflow-hidden text-ellipsis`}
                    >
                        {value}
                    </span>
                </div>
